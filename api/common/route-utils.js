...
export function sendUnauthorized(res, user, permission) {
  sendStatus(res, 403, false, `Gebruiker ${user} heeft geen toegang voor ${permission}.`);
}
...
/**
 * Catch resource not found error.
 * @function catchResourceNotFoundError
 * @param {Object} res Express response object
 * @param {Object} exception Exception object
 * @returns {undefined}
 */
export function catchResourceNotFoundError(res, exception) {
